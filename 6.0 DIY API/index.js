...
app.get('/jokes/:id', (req, res) => {
  ...
  if (joke) {
    ...
    res.json({ message: `joke ${req.params.id} not found..` });
  }
});
...
app.get('/filter', (req, res) => {
  ...
  if (filterJokes) {
    ...
    res.json({ message: `no joke found of type ${type}.` });
  }
});
...
app.patch('/jokes/:id', (req, res) => {
  ...
  const updateJoke = {
    id,
    jokeText: text || jokes[idx].jokeText,
    jokeType: type || jokes[idx].jokeType
  };
...
app.delete('/jokes/:id', (req, res) => {
  // const idx = jokes.findIndex(joke => joke.id === + req.params.id);
